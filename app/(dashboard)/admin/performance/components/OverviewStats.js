        ...
        {change && (
          <div className="mt-4">
            ...
            >
              ...
              <span>
                {Math.abs(change)}% {isIncrease ? "increase" : "decrease"} from
                previous period
              </span>
            </div>
          </div>
  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
      <StatCard
        ...
        isIncrease={data.totalUsers.change > 0}
        icon={
          <svg
            className="h-6 w-6"
            fill="none"
      ...
      <StatCard
        ...
        value={data.activeSessions.value}
        change={data.activeSessions.change}
        isIncrease={data.activeSessions.change > 0}
        icon={
          <svg
            className="h-6 w-6"
            fill="none"
      ...
      <StatCard
        ...
        isIncrease={data.completionRate.change > 0}
        icon={
          <svg
            className="h-6 w-6"
            fill="none"
      ...
      <StatCard
        ...
        change={data.averageRating.change}
        isIncrease={data.averageRating.change > 0}
        icon={
          <svg
            className="h-6 w-6"
            fill="none"
