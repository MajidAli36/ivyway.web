...
const DUMMY_TICKETS = [
  {
    id: 1,
    title: "Session Scheduling Issue",
    status: "resolved",
    priority: "high",
    ...
    category: "scheduling",
    description:
      "Unable to schedule counseling sessions with students. The system keeps showing an error.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "technical",
    description: "Changes to my counselor profile are not being saved.",
  },
  {
    id: 4,
...
const DUMMY_FAQS = [
  {
    id: 1,
    question: "How do I set my availability for counseling sessions?",
    answer:
      "Go to the 'Availability' section in your dashboard, select your available time slots, and save. Students will be able to book sessions during these times.",
    category: "scheduling",
  },
  {
    id: 2,
    question: "How do I get paid for my counseling sessions?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Use the 'Messages' section to communicate with students. You can also provide guidance through the 'Offer Guidance' feature.",
    category: "communication",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    question: "How do I update my counselor profile?",
    answer:
  ...
  {
    id: 6,
    question: "What subjects can I provide counseling for?",
    answer:
      "You can provide counseling for a wide range of academic and career topics. Update your expertise areas in your profile to attract relevant students.",
    category: "subjects",
  },
];
          ...
          <div className="flex items-center">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Get help with your counseling account, sessions, payments, and more
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="h-96 border border-gray-200 rounded-lg">
                <SupportChat userRole="counselor" className="h-full" />
              </div>
            </div>
          </div>
        )}
