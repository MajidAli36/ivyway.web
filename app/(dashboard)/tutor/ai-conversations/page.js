...
// Dummy conversation data for tutors
const DUMMY_CONVERSATIONS = [
  {
    id: 1,
    title: "Teaching Strategy Discussion",
    lastMessage: "What's the best way to explain calculus to beginners?",
  ...
  },
  {
    ...
    lastMessage: "How can I track my student's improvement?",
  ...
  },
  {
    ...
    lastMessage: "Thanks for the lesson plan suggestions!",
  ...
  },
  {
    ...
    lastMessage: "When will my payments be processed?",
  ...
  {
    id: 5,
    title: "Tutor Upgrade Guidance",
    lastMessage: "What are the requirements for Advanced Tutor?",
...
export default function TutorAIConversationsPage() {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Get help with tutoring and support
            </p>
          </div>
        </div>
